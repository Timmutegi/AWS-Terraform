...
def add_lambda_permission(data):
    ...
    """    
    source_arn = "arn:aws:execute-api:{aws-region}:{aws-acct-id}:{aws-api-id}/*/POST/{lambda-function-name}".format(**data)
...
def get_api_root_id(rest_api_id):
    ...
    :param rest_ai_id: The ID of the API
...
def demo():
    ...
    API_RESOURCE_ID = create_api_resource(REST_API_ID, API_ROOT_ID, LAMBDA_FUNCTION_NAME)
